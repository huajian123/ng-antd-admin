...
export const handlers = [
  ...
  http.post('/site/api/sysPermission/list', () => {
    return HttpResponse.json({
      code: 0,
      msg: 'SUCCESS',
      data: {
  ...
  http.post('/site/api/department/list/', () => {
    return HttpResponse.json({
      code: 0,
      msg: 'SUCCESS',
      data: {
